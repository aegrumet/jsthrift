...
/*
 * Javascript port of thrift parse-time data structures.
 * Based loosely on
...
(function () {
    ...
    t_struct.prototype.append = function (elem) {
        ...
        var offset = -1,
            i;
        for (i = 0; i < this._members_in_id_order.length; i++) {
    ...
    t_base_type.prototype.t_base_name = function (tbase) {
        switch (tbase) {
        case this.t_base.TYPE_VOID:
            return "void";
        case this.t_base.TYPE_STRING:
            return "string";
        case this.t_base.TYPE_BOOL:
            return "bool";
        case this.t_base.TYPE_BYTE:
            return "byte";
        case this.t_base.TYPE_I16:
            return "i16";
        case this.t_base.TYPE_I32:
            return "i32";
        case this.t_base.TYPE_I64:
            return "i64";
        case this.t_base.TYPE_DOUBLE:
            return "double";
        default:
            return "(unknown)";
        }
